...
public class AdminReplenishmentRequestView extends View {
    ...
    public void render() {
        ...
        TextInputField requestField = new TextInputField(
                String.format("Choose a request to approve or reject (1-%d)", requests.size()));
...
// new Align(Alignment.CENTER, new Text(" [ Inventory Replenishment Request ] ",
